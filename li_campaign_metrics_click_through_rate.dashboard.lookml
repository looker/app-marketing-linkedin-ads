- dashboard: li_campaign_metrics_click_through_rate
  ...
  - title: Click Rate to Date
    ...
    y_axes: [{label: '', orientation: left, series: [{id: fact.total_conversions,
            name: Conversions, axisId: fact.total_conversions, __FILE: app-marketing-linkedin-ads/li_campaign_metrics_click_through_rate.dashboard.lookml,
            __LINE_NUM: 56}], showLabels: true, showValues: true, unpinAxis: false,
        tickDensity: default, tickDensityCustom: 5, type: linear, __FILE: app-marketing-linkedin-ads/li_campaign_metrics_click_through_rate.dashboard.lookml,
        __LINE_NUM: 53}, {label: '', orientation: left, series: [{id: fact.average_cost_per_click,
            name: Cost per Click, axisId: fact.average_cost_per_click, __FILE: app-marketing-linkedin-ads/li_campaign_metrics_click_through_rate.dashboard.lookml,
            __LINE_NUM: 68}], showLabels: true, showValues: true, unpinAxis: false,
        tickDensity: default, type: linear, __FILE: app-marketing-linkedin-ads/li_campaign_metrics_click_through_rate.dashboard.lookml,
        __LINE_NUM: 65}, {label: '', orientation: left, series: [{id: fact.average_conversion_rate,
            name: Conversion Rate, axisId: fact.average_conversion_rate, __FILE: app-marketing-linkedin-ads/li_campaign_metrics_click_through_rate.dashboard.lookml,
        ...
        __LINE_NUM: 76}, {label: !!null '', orientation: left, series: [{id: fact.average_click_rate,
            name: Click Through Rate, axisId: fact.average_click_rate, __FILE: app-marketing-linkedin-ads/li_campaign_metrics_click_through_rate.dashboard.lookml,
        ...
        __LINE_NUM: 87}, {label: !!null '', orientation: left, series: [{id: fact.average_cost_per_conversion,
            name: Cost per Conversion, axisId: fact.average_cost_per_conversion, __FILE: app-marketing-linkedin-ads/li_campaign_metrics_click_through_rate.dashboard.lookml,
    ...
    width: 18
    height: 12
  - title: Ad Click Rate Change
    name:  Ad Click Rate Change
    model: marketing_analytics
    explore: linkedin_ad_date_fact
    type: looker_bar
    fields: [fact.average_click_rate, last_fact.average_click_rate, fact.average_click_rate_period_percent_change,
    ...
    y_axes: [{label: '', maxValue: !!null '', minValue: !!null '', orientation: bottom,
        ...
        type: linear, unpinAxis: false, valueFormat: !!null '', series: [{id: fact.average_click_rate,
            name: Period Fact, axisId: fact.average_click_rate, __FILE: app-marketing-config-5f71074d49e24011ceee3a8ee7cf1e94-17c0a9c0ef0b6e37e243eeece3212db4462642e5/bi_campaign_metrics_click_through_rate.dashboard.lookml,
            __LINE_NUM: 672}, {id: last_fact.average_click_rate, name: Last Period
              Fact, axisId: last_fact.average_click_rate, __FILE: app-marketing-config-5f71074d49e24011ceee3a8ee7cf1e94-17c0a9c0ef0b6e37e243eeece3212db4462642e5/bi_campaign_metrics_click_through_rate.dashboard.lookml,
            __LINE_NUM: 677}], __FILE: app-marketing-config-5f71074d49e24011ceee3a8ee7cf1e94-17c0a9c0ef0b6e37e243eeece3212db4462642e5/bi_campaign_metrics_click_through_rate.dashboard.lookml,
        __LINE_NUM: 660}]
    show_y_axis_labels: true
    show_y_axis_ticks: true
    y_axis_tick_density: default
    ...
    conditional_formatting_include_totals: false
    conditional_formatting_include_nulls: false
    hidden_fields: [ad_group.ad_group_name, campaign.name, fact.average_click_rate_period_percent_change,
  ...
  - title: Click Rate By Day Of Week
    name: Click Rate By Day Of Week
    model: marketing_analytics
    explore: linkedin_ad_date_fact
    type: looker_bar
    ...
    width: 6
    height: 12
  - title: Click Rate By Bid Type
    name: Click Rate By Bid Type
    model: marketing_analytics
    explore: linkedin_ad_date_fact
    type: looker_bar
    fields: [fact.bid_type, fact.average_click_rate]
    filters: {}
