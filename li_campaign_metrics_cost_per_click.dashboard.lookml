- dashboard: li_campaign_metrics_cost_per_click
  ...
  - title: Cost Per Click To Date
    ...
    y_axes: [{label: '', orientation: left, series: [{id: fact.total_conversions,
            name: Conversions, axisId: fact.total_conversions, __FILE: app-marketing-linkedin-ads/li_campaign_metrics_cost_per_click.dashboard.lookml,
            __LINE_NUM: 56}], showLabels: true, showValues: true, unpinAxis: false,
        tickDensity: default, tickDensityCustom: 5, type: linear, __FILE: app-marketing-linkedin-ads/li_campaign_metrics_cost_per_click.dashboard.lookml,
        __LINE_NUM: 53}, {label: '', orientation: left, series: [{id: fact.average_cost_per_click,
            name: Cost per Click, axisId: fact.average_cost_per_click, __FILE: app-marketing-linkedin-ads/li_campaign_metrics_cost_per_click.dashboard.lookml,
            __LINE_NUM: 68}], showLabels: true, showValues: true, unpinAxis: false,
        tickDensity: default, type: linear, __FILE: app-marketing-linkedin-ads/li_campaign_metrics_cost_per_click.dashboard.lookml,
        __LINE_NUM: 65}, {label: '', orientation: left, series: [{id: fact.average_conversion_rate,
            name: Conversion Rate, axisId: fact.average_conversion_rate, __FILE: app-marketing-linkedin-ads/li_campaign_metrics_cost_per_click.dashboard.lookml,
        ...
        __LINE_NUM: 76}, {label: !!null '', orientation: left, series: [{id: fact.average_click_rate,
            name: Click Through Rate, axisId: fact.average_click_rate, __FILE: app-marketing-linkedin-ads/li_campaign_metrics_cost_per_click.dashboard.lookml,
            __LINE_NUM: 90}, {id: fact.average_cost_per_conversion, name: Cost per
              Conversion, axisId: fact.average_cost_per_conversion, __FILE: app-marketing-linkedin-ads/li_campaign_metrics_cost_per_click.dashboard.lookml,
  ...
  - title: Cost Per Click By Bid Type
    ...
    explore: linkedin_ad_date_fact
    type: looker_bar
    fields: [fact.average_cost_per_click, fact.bid_type]
    filters: {}
  ...
  - title: Ad Cost Per Click Change
    ...
    explore: linkedin_ad_date_fact
    type: looker_bar
    fields: [fact.average_cost_per_click, last_fact.average_cost_per_click, fact.average_cost_per_click_period_percent_change,
    ...
    y_axes: [{label: '', maxValue: !!null '', minValue: !!null '', orientation: bottom,
        ...
        type: linear, unpinAxis: false, valueFormat: !!null '', series: [{id: fact.average_cost_per_click,
            name: Period Fact, axisId: fact.average_cost_per_click, __FILE: app-marketing-config-5f71074d49e24011ceee3a8ee7cf1e94-17c0a9c0ef0b6e37e243eeece3212db4462642e5/bi_campaign_metrics_cost_per_click.dashboard.lookml,
            __LINE_NUM: 774}, {id: last_fact.average_cost_per_click, name: Last Period
              Fact, axisId: last_fact.average_cost_per_click, __FILE: app-marketing-config-5f71074d49e24011ceee3a8ee7cf1e94-17c0a9c0ef0b6e37e243eeece3212db4462642e5/bi_campaign_metrics_cost_per_click.dashboard.lookml,
            __LINE_NUM: 779}], __FILE: app-marketing-config-5f71074d49e24011ceee3a8ee7cf1e94-17c0a9c0ef0b6e37e243eeece3212db4462642e5/bi_campaign_metrics_cost_per_click.dashboard.lookml,
        __LINE_NUM: 762}]
    show_y_axis_labels: true
    show_y_axis_ticks: true
    y_axis_tick_density: default
    ...
    conditional_formatting_include_totals: false
    conditional_formatting_include_nulls: false
    hidden_fields: [ad_group.ad_group_name, campaign.name, fact.average_cost_per_click_period_percent_change,
